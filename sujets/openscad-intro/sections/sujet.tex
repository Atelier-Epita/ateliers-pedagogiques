...
\hint{
Le caractère \# placé devant un objet permet de l'afficher en transparence.
Il peut s'avérer utile afin de visualiser des objets extrudés, comme c'est le cas ici avec le trou et le texte.}
...
\warning{
Il ne faut pas creuser le texte sur toute la longueur de la pièce, sinon l'impression ne pourra pas fonctionner.
Faites attention à laisser une épaisseur suffisante en dessous du texte.}
